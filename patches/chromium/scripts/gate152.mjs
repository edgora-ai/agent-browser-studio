...
const refPath = path.resolve(
  refArg ?? new URL("../corpora-152/stock-chrome-152.0.7977.64.json", import.meta.url).pathname,
);
...
check(
  "UA version family",
  /Chrome\/152\./.test(ours.userAgent) || /152\./.test(version),
