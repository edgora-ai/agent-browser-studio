...
//
// macOS browser bundles are embedded as opaque .app.zip resources, so recursive
// signing cannot rewrite their Framework symlinks or nested signatures. Re-sign
// the complete Electron app deeply to replace stale framework/helper signatures;
// the browser archives retain the signatures verified by sync-native-browsers.
